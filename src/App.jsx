...
function App() {
  ...
  const GoogleIcon = () => (
    <svg className='group-hover:text-primary transition-all text-secondary fill-current md:w-12 w-8' viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const FacebookIcon = () => (
    <svg className='group-hover:text-primary transition-all text-secondary fill-current md:w-12 w-8' viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const YoutubeIcon = () => (
    <svg className='group-hover:text-primary transition-all text-secondary fill-current md:w-12 w-8' viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const DataAnalyticsIcon = () => (
    <svg className='group-hover:text-primary transition-all text-secondary fill-current md:w-12 w-8' viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const ServiceCard = ({ title, description, icon: IconComponent }) => (
    <div className='p-4 rounded-2xl bg-secondary/10 flex flex-col justify-between hover:bg-secondary/80 hover:text-primary transform hover:-rotate-2 group transition-all'>
      <div className='flex flex-col md:gap-2 gap-1'>
        <IconComponent />
        <h3 className='md:text-2xl text-xl font-semibold'>{title}</h3>
        <p className='md:text-lg text-md'>{description}</p>
      </div>
      <a className='flex mt-10 items-center gap-2 group-hover:text-primary text-secondary transition-all stroke-current' href="">
        Learn more
        <ArrowIcon />
      </a>
    </div>
  ...
  const TestimonialCard = ({ name, title, company, quote }) => (
    <div className='bg-[#2C444C] p-6 rounded-3xl min-w-[320px] flex flex-col justify-between'>
      <QuoteIcon />
  ...
  const portfolioItems = [
    {
      title: 'Sales Ad Setup & Optimizations',
      ...
      tags: ['ads', 'optimization', 'sales'],
      image: 'https://images.unsplash.com/photo-1620207418302-368027437f6e?q=80&w=1740&auto=format&fit=crop',
    },
    {
      title: 'Facebook Ads Management',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1616499879799-a93108151214?q=80&w=1740&auto=format&fit=crop',
    },
    {
  ...
  const Arrowicon = () => (
    <svg className="w-6 h-6 text-primary group-hover:rotate-45 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M7 17L17 7M17 7H7M17 7V17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );

  const PortfolioCard = ({ title, description, tags, image }) => (
    <div className='bg-white rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-300 p-2 md:p-4 group'>
      <div className='flex flex-col md:flex-row gap-6 md:gap-8'>
        {/* Image Area */}
        <div className='flex-shrink-0 w-full md:w-2/5'>
          <img src={image} alt={title} className='rounded-xl bg-amber-700 w-full h-48 sm:h-64 object-cover' />
        </div>
        ...
        <div className='flex-grow flex flex-col justify-between'>
          <div>
            <div className='flex items-start justify-between mb-4'>
              <h3 className='text-xl sm:text-2xl font-bold text-secondary'>{title}</h3>
              <div className='w-10 h-10 bg-secondary text-primary rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110'>
                <Arrowicon />
              </div>
            </div>
          ...
          <div className='flex flex-wrap gap-2'>
            {tags.map((tag, index) => (
              <span key={index} className='text-xs font-medium bg-gray-200 text-gray-700 px-3 py-1 rounded-full'>{tag}</span>
            ))}
          </div>
        </div>
      </div>
  ...
  const ContactForm = () => (
    <div className='md:w-[40%] w-full'>
      <h2 className='text-4xl font-serif text-center mb-10'>Get in touch</h2>
      <form className='flex flex-col gap-4'>
        <input
          type='text'
          placeholder='Name'
          className='p-4 rounded-xl bg-secondary/80 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-600'
        />
        <input
          type='email'
          placeholder='Email'
        ...
        <textarea
          ...
          rows='5'
          className='p-4 rounded-xl bg-secondary/80 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-600 resize-none'
        ></textarea>
        <button
          type='submit'
          className='bg-secondary hover:bg-gray-700 text-white font-bold py-3 rounded-xl transition-colors'
        >
          Send Message
        </button>
      </form>
  ...
  const Footer = () => (
    <footer className='bg-secondary/7 text-secondary'>
      <div className='max-w-7xl mx-auto px-4 md:px-6'>
        <div className='flex flex-col md:flex-row py-10 items-center justify-between'>
          {/* Left Section - Logo and Navigation */}
          <div className='flex items-center'>
            <div className='flex gap-4 items-center'>
              <svg className='h-15 stroke-current text-secondary' viewBox="0 0 49 37" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='text-md uppercase tracking-widest flex flex-col'>
          ...
          <div className='flex items-center gap-1 text-md text-gray-600'>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 10.5C15 11.2956 14.6839 12.0587 14.1213 12.6213C13.5587 13.1839 12.7956 13.5 12 13.5C11.2044 13.5 10.4413 13.1839 9.87868 12.6213C9.31607 12.0587 9 11.2956 9 10.5C9 9.70435 9.31607 8.94129 9.87868 8.37868C10.4413 7.81607 11.2044 7.5 12 7.5C12.7956 7.5 13.5587 7.81607 14.1213 8.37868C14.6839 8.94129 15 9.70435 15 10.5Z" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M19.5 10.5C19.5 17.642 12 21.75 12 21.75C12 21.75 4.5 17.642 4.5 10.5C4.5 8.51088 5.29018 6.60322 6.6967 5.1967C8.10322 3.79018 10.0109 3 12 3C13.9891 3 15.8968 3.79018 17.3033 5.1967C18.7098 6.60322 19.5 8.51088 19.5 10.5Z" stroke="#1F1F1F" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        ...
        <div className='text-sm text-secondary/70 text-center'>
          <div className='w-full h-[1px] bg-secondary/70'></div>
          <p className='py-2'>Copyright © Reserved. Website developed by <a className=' hover:underline' href="https://www.linkedin.com/in/rafi-mozumder/" target='_blank' >Rafi Mazumder</a></p>
        </div>
      </div>
  ...
  return (
    <main className='bg-primary overflow-hidden'>
      ...
      <section id='services' className='md:h-screen flex items-center'>
        <div className='max-w-7xl mx-auto md:px-8 px-4'>
          <div className='py-10 flex items-center justify-between'>
            <div>
              <h1 className='md:text-4xl text-2xl'>My Services</h1>
              <p className='leading-5 mt-1 text-wrap w-[60%]'>harum nostrum optio necessitatibus velit.</p>
            </div>
            <button className='p-2 md:px-4 px-3 md-text-md text-sm bg-secondary rounded-full text-primary cursor-pointer hover:bg-secondary/70'>Get Started</button>
          </div>
      ...
      {/*Testimonial section*/}
      <section id='testimonial' className='h-screen flex items-center'>
        <div className='max-w-7xl mx-auto md:px-8 px-4'>
          <div className='py-10 flex items-center justify-between'>
            <div>
              <h1 className='md:text-4xl text-2xl'>Client Success Stories</h1>
              <p className='w-100 leading-5 mt-1'>blanditiis eos optio assumenda! Dolorem asperiores, praesentium harum nostrum optio necessitatibus velit.</p>
            </div>
          </div>
      ...
      <section className='h-screen flex flex-col'>
        <div className='flex-grow md:p-6 p-4 flex items-center justify-center'>
          <ContactForm />
        </div>
        <Footer />
      </section>
